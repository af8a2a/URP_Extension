using System;
using Features.Filter.IBLFilter;
...
namespace Features.Sky
{
    ...
    internal class SkySystem : IDisposable
    {
        ...
        internal static SkySystem instance
        {
            get
            {
                if (m_Instance == null)
                {
                    ...
                    m_Instance.Build(UniversalRenderPipeline.asset, shaders);
                }
        ...
        internal SkySettings GetSkySettings(VolumeStack volumeStack)
        {
            ...
            switch (typeEnum)
            {
                ...
                case SkyType.Gradient:
                    skyType = typeof(GradientSky.GradientSkySetting);
                    break;
                case SkyType.HDRI:
                default:
                    skyType = typeof(HDRISky.HDRISkySetting);
                    break;
            }
        ...
        public void Build(UniversalRenderPipelineAsset asset, SkyRuntimeResources runtimeResources)
        {
            m_LowResolution = 16;
