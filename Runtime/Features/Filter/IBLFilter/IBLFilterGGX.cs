...
namespace Features.Filter.IBLFilter
{
    class IBLFilterGGX : IBLFilterBSDF
    {
        ...
        internal static IBLFilterGGX instance
        {
            get
            {
                if (m_Instance == null)
                {
                    ...
                    var shaders = GraphicsSettings.GetRenderPipelineSettings<IBLFilterRuntimeShader>();
                    m_Instance.Initialize(shaders);
                }
        ...
        public override void Initialize(IBLFilterRuntimeShader runtimeShaders)
        {
